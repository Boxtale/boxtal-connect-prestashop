...
install_unit_tests() {
  ...
  if [[ -f $PS_REPO_DIR/composer.json ]]; then
    sudo -u www-data -H sh -c "sed -i \"s/https:\/\/github.com\/prestashop\/php-cssjanus/git@github.com:PrestaShop\/php-cssjanus.git/\" $PS_CORE_DIR/modules/boxtalconnect/boxtalconnect.php"
