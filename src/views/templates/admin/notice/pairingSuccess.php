...
<div class="module_confirmation conf confirm alert alert-success">
    <p><?php
        echo sprintf(
            $boxtalConnect->l('Congratulations! You\'ve successfully paired your site %s with Boxtal.'),
            $shopName
        ); ?>
    </p>
    <p>
        <a class="bx-hide-notice btn btn-primary-reverse btn-outline-primary" data-key="pairing"
